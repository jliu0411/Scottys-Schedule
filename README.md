# Scotty's Schedule - CS 180 Project
<p align="center"><img align="center" width="195" height="175" alt="scottyHead" src="https://github.com/user-attachments/assets/defa4c6f-7bd9-445c-b55e-f773a4ab00d0" /></p>
...
##
As a note, all commands should be run inside the inner `Scottys-Schedule` folder.
## Dependencies
```bash
...
npx expo start
```
Using Expo Go on an Android device, or an Android Emulator such as Android Studio, scan the QR code that will appear in the terminal to run Scotty's Schedule.
